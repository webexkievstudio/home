        ...
        <div class="row about">
            <div class="col-lg-6 col-lg-offset-3 col-md-10 col-md-offset-1 col-sm-8 col-sm-offset-2 col-xs-12">
                <div class="white-realm" id="portfolio">
                    ...
                    <div class=" visible-xs" id="staticPortfolio">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
                            <div class="breeds-xs">
                                <a class="button button-black button-full-width-xs btn-more-pj" href="">Больше проектов</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="swiper-container">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    ...
                                    <p class="position">Project Manager</p>
                                    <a class="fb-visible-xs" href=""> <span class="fa-stack fa-lg">
                             <i class="fa fa-circle fa-stack-2x"></i>
                             <i class="fa fa-stack-1x fa-facebook"></i>
                             </span></a>
                                </div>
                ...
                <div class="white-realm price-table" id="services">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <hr class="greyHr">
                            <div class="container">
                                <p>За разработку адаптивной и мобильной версии +30% к цене</p>
                            </div>
                            <hr class="greyHr">
                            <div class="col-sm-6 col-sm-offset-3  col-xs-12 breeds">
                                <a class="button button-black" href="">Узнать больше</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-xs-12 col-md-5 col-md-offset-1">
                            ...
                            <form id="phoneUs" method="POST">
                                <div class="row">
                                    <div class="col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2 col-xs-12">
                                        <div class="form-group">
                                            <input type="tel" id="phoneUsClientPhone" placeholder="+__(___)___-__-__">
                                        </div>
                                    </div>
                                    <div id="phoneUsControl" class="col-sm-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2 col-xs-12">
                                        <div class="form-group">
                        ...
                        <div class="col-sm-6 col-xs-12 col-md-5 write-us">
                            <h3>Напишите нам</h3>
                            <form id="writeUs" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-sm-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-3 col-xs-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-3 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="writeUsClientInquiry" rows="1" required="required">
                                            </textarea>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-3 col-xs-12">
                                        <div class="form-group plus">
                                            <a href=""> <i></i><span>Прикрепить файл</span>
                                            </a>
                                            <input type="file" id="addFileInput" class="addFile">
                                        </div>
                                    </div>
                                    <div id="writeUsControl" class="col-sm-12 col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-3 col-xs-12">
                                        <div class="form-group">
